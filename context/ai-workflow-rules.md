...
what to build, how to build it, and what the current state of progress is. Always
...
- Real-time canvas statel and database persistence
...
Do not modify generated third-party foundation components unless explicitly
instructed.
...
Progress state must reflect the actual state of the implementation, not the intended
state.
